![123](https://img-blog.csdnimg.cn/20201112110229415.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2NsZWFubGlp,size_16,color_FFFFFF,t_70#pic_center)
...
## Preface
- Shell is the container
- Shell is the burden
- Shell is the heaviest part of life
- Shell is the guideline for the construction of the universe
- From the Earth's crust to the cell membrane
- The continuation and transmission of life
...
## Features
### Scripts
- More than 20,000 words of original scripts
- More than 300 original prop phrases
- More than 50 original art materials
...
##### Loss & Recovery
- **Core**: all mechanisms revolve around shell breaks.
- **Loss**: being attacked by enemies, activating shell power, replacing shells, falling, etc.
- **Recovery**: nests (bonfires), treasure chests, absorption of shells, special shell power, etc.
##### Backstab
...
##### Charging & Picking
- **Charging**: each interaction with shell power will increase the shell break value permanently unless the shell is replaced.
- **Picking**: when picking up a new shell, the player can choose to absorb the shell power (restoring shell break value) or replace it with a new shell power (aggravating shell break value).
##### Various Shells
...
##### Weak Social Chains
- The only way to create connection between players - the message left on the shell – the spell;
- The only way to exchange information about other players' shells - dropping after death / dedicating their shells;
- Writing messages - set at birth, and can be refreshed after death which can be changed at any time;
##### Gameplays
- Various Builds
- Death in the level
- Donation to other players
- Giving good/bad reviews
##### Social Motivation: Smart Drugs
- Refering to Bridge Links from Death Stranding
- Refering to Message System from Dark Souls
...
##### Bonfire: The Nest
- **The Nest**: i.e. "bonfire", providing shell power value recovery, destroyed after use until next game;
- **Death-penalty System**: if the character died in a level, the shell power and all level elements will reset;
- **High Difficulty**: reflected in high enemy damage, high complexity of the terrain, etc;
- **Storytelling**: a small amount of dialogue and spells;
